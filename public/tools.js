...
function openTools() {
    const iconEleme = optionsCont.children[0];
    iconEleme.classList.remove("fa-times");
    iconEleme.classList.add('fa-bars');
    toolsCont.style.display = "flex";
}

function closeTools() {
    const iconEleme = optionsCont.children[0];
    iconEleme.classList.remove("fa-bars");
    iconEleme.classList.add('fa-times');
